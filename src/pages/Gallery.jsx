...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Focused on building meaningful things — one step at a time. ",
      photos: ["/gallery/proffesional_image.jpg"],
    },

    {
      id: 2,
      caption: "Late nights, quiet roads, clearer thoughts. ",
      photos: ["/gallery/roadside.jpg"],
    },
    
    {
      id: 3,
      caption: "Building my own Jarvis, one line of code at a time.",
      photos: ["/gallery/mywork.png "],
    },
  ...
  projects: [
    {
      id: 1,
      caption:
        "An AI-powered planner that turns complexity into clarity.",
      photos: ["/gallery/business_model.png"],
    },
    
    {
      id: 2,
      caption:
        "📂TaskFlow — turning daily tasks into focused progress.",
      photos: ["/gallery/Taskflow.png"],
    },
  ],
